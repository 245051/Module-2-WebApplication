...
var newScore = scores.map(function (score) {
    return score * 2;
});
console.log(yearsplayed);
var sortedScores = scores.sort(function (score1, score2) {
    if (score1 > score2) {
        return 1;
        //return -1 in here is  descending order
    }
    else {
        return -1;
        //return 1 in here is ascending order.
    }
});
console.log(sortedScores);
var sortTotalScores = players.sort(function (players1, players2) {
    if (players1.total_runs < players2.total_runs) {
        return 1;
    }
    else {
        return -1;
